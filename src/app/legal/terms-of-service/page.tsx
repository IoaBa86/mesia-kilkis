      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="border border-mesia-gold/25 bg-white p-8 md:p-10">
          <div className="prose prose-lg max-w-none">
            ...
            <p>Η ιστοσελίδα «Μεσιά Κιλκίς» είναι ανεξάρτητη ενημερωτική ιστοσελίδα και παρέχει:</p>
            <ul>
            ...
            <div className="bg-red-50 p-6 rounded-lg border border-red-200 mt-4">
              ...
              <ul className="space-y-1 text-red-700">
                ...
                <li>❌ Δημοσίευση ή αποστολή παράνομου, προσβλητικού ή παραπλανητικού περιεχομένου μέσω email</li>
            ...
            <p>Η ιστοσελίδα εμφανίζει διαφημίσεις μέσω του δικτύου Google AdSense για την κάλυψη του κόστους λειτουργίας της ιστοσελίδας. Η επιλογή και το περιεχόμενο των διαφημίσεων καθορίζεται από τη Google και ενδέχεται να βασίζεται στη συγκατάθεσή σας για εξατομικευμένη διαφήμιση (βλ. <Link href="/legal/cookie-policy" className="text-mesia-wine hover:text-mesia-gold">Πολιτική Cookies</Link>). Δεν φέρουμε ευθύνη για το περιεχόμενο τρίτων διαφημίσεων.</p>

            <h2 className="text-2xl font-bold text-mesia-wine font-greek mb-4">6. Υποβολή Περιεχομένου</h2>
            <p>Εάν μας αποστείλετε περιεχόμενο (π.χ. φωτογραφίες ή πληροφορίες προς δημοσίευση) μέσω email:</p>
            <ul>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
              ...
              <ul>
                <li>Ακρίβεια ή επικαιρότητα πληροφοριών (δρομολόγια, αποστάσεις, στοιχεία επικοινωνίας τρίτων κ.λπ.)</li>
