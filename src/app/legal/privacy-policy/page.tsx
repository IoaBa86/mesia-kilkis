          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-8 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <p className="text-sm text-yellow-900 mb-0">
                ...
                πώς λειτουργεί η ιστοσελίδα σήμερα και δεν αποτελεί νομική συμβουλή.
              </p>
            </div>
            ...
            <div className="bg-mesia-lightCream/50 p-4 rounded-lg mb-6">
              ...
              <p><strong>Υπεύθυνος επεξεργασίας:</strong> η ομάδα διαχείρισης της ιστοσελίδας «Μεσιά Κιλκίς»</p>
              <p><strong>Επικοινωνία για θέματα προστασίας δεδομένων:</strong> μόνο μέσω email, στο info@mesia.gr</p>
              <p className="text-sm text-mesia-lightText mb-0">
                Η ιστοσελίδα δεν σχετίζεται με την Τοπική Κοινότητα Μεσιάς, τον Δήμο Παιονίας ή άλλον δημόσιο φορέα.
              </p>
            </div>
