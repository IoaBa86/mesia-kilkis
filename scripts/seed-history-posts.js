...
> «Από το Μπαλμπά Κιόϊ στη σύγχρονη Μεσιά — μια διαδρομή αιώνων που συνεχίζεται»`,
  },
  {
    ...
    excerpt: 'Ιστορικό διατηρητέο μνημείο του 15ου–16ου αιώνα, με ενσωματωμένο μουσουλμανικό τέμενος κτισμένο από αρχαία υλικά.',
    isPinned: false,
...
Έχει ενσωματωθεί μουσουλμανικό τέμενος κτισμένο με μαρμάρινους δόμους σε Β' χρήση, που προέρχονται από αρχαίο κτήριο.
